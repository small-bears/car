				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('ershouchexinxi','定金支付')" @click="onAcrossTap('dingjinzhifu')" type="button" class="layui-btn">
								定金支付
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`ershouchexinxi`);
