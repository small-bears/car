...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">评估报价管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>评估报价列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">评估报价列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chekuangmiaoshu')">车况描述<i id="chekuangmiaoshuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('pinggujia')">评估价<i id="pinggujiaIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var pinggujiaCell  = document.createElement('td');

						 pinggujiaCell.innerHTML = item.pinggujia;


			row.appendChild(pinggujiaCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("pinggubaojia/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"pinggubaojia");
