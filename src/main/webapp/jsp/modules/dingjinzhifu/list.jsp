...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">定金支付管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>定金支付列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">定金支付列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('dingjinjine')">订金金额<i id="dingjinjineIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('fukuanriqi')">付款日期<i id="fukuanriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var dingjinjineCell  = document.createElement('td');

						 dingjinjineCell.innerHTML = item.dingjinjine;


			row.appendChild(dingjinjineCell);
			var fukuanriqiCell  = document.createElement('td');

						  fukuanriqiCell.innerHTML = item.fukuanriqi;


			row.appendChild(fukuanriqiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("dingjinzhifu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"dingjinzhifu");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"dingjinzhifu");
