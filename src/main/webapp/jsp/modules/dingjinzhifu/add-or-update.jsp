		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑定金支付</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>定金支付管理</span></li>
								<li class="breadcrumb-item active"><span>编辑定金支付</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">定金支付信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>订金金额</label>
										<input id="dingjinjine" name="dingjinjine" class="form-control" placeholder="订金金额">
									</div>
									<div class="form-group col-md-6">
										<label>付款日期</label>
										<div id="fukuanriqiDate" class="input-append date form_datetime">
											<input id="fukuanriqi-input" name="fukuanriqi" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "dingjinzhifu/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("dingjinzhifu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("dingjinzhifu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#dingjinjine").val(ruleForm.dingjinjine);	
			$("#fukuanriqi-input").val(ruleForm.fukuanriqi);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.dingjinjine != null && res.data.dingjinjine != ''){

					$("#dingjinjine").val(res.data.dingjinjine);
					}
					if(res.data != null && res.data != '' && res.data.fukuanriqi != null && res.data.fukuanriqi != ''){

					$("#fukuanriqi-input").val(res.data.fukuanriqi);
					$('#fukuanriqiFileName').val(res.data.fukuanriqi)
					}
