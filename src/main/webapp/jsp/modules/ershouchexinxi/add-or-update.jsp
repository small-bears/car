		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑二手车信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>二手车信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑二手车信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">二手车信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>车身颜色</label>
										<input id="cheshenyanse" name="cheshenyanse" class="form-control" placeholder="车身颜色">
									</div>
									<div class="form-group col-md-6">
										<label>上牌时间</label>
										<div id="shangpaishijianDate" class="input-append date form_datetime">
											<input id="shangpaishijian-input" name="shangpaishijian" size="15" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>行驶里程</label>
										<input id="xingshilicheng" name="xingshilicheng" class="form-control" placeholder="行驶里程">
									</div>
									<div class="form-group col-md-6">
										<label>售价</label>
										<input id="shoujia" name="shoujia" class="form-control" placeholder="售价">
									</div>
									<div class="form-group col-md-6">
										<label>车况描述</label>
										<textarea name="chekuangmiaoshu" class="form-control" id="chekuangmiaoshu" rows="3"></textarea>
									</div>
	...
	<script>
		...
		var fenleiOptions = [];
				...
				function fenleiSelect(){
					http("option/ershouchefenlei/fenlei","GET",{},(res)=>{
						if(res.code == 0){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "ershouchexinxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("ershouchexinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("ershouchexinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#shangpaishijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function calculationSE(colName){
			//单列求和接口
			http("ershouchexinxi"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#shangpaishijian-input").val(ruleForm.shangpaishijian);
			$("#xingshilicheng").val(ruleForm.xingshilicheng);	
			$("#shoujia").val(ruleForm.shoujia);	
			$("#chekuangmiaoshu").val(ruleForm.chekuangmiaoshu);
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shangpaishijian != null && res.data.shangpaishijian != ''){

					$("#shangpaishijian-input").val(res.data.shangpaishijian);
					$('#shangpaishijianFileName').val(res.data.shangpaishijian)
					}
					if(res.data != null && res.data != '' && res.data.xingshilicheng != null && res.data.xingshilicheng != ''){

					$("#xingshilicheng").val(res.data.xingshilicheng);
					}
					if(res.data != null && res.data != '' && res.data.shoujia != null && res.data.shoujia != ''){

					$("#shoujia").val(res.data.shoujia);
					}
					if(res.data != null && res.data != '' && res.data.chekuangmiaoshu != null && res.data.chekuangmiaoshu != ''){

					$("#chekuangmiaoshu").val(res.data.chekuangmiaoshu);
					}
				}
			});  
            }
